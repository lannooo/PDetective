...
# ==========================================
EXP_NAME="baseline_multireso"
CONFIG="config/model/baseline_multireso.yaml"
ASSESS_CONFIG="config/assess/1_PES_cap_base_0.02_4.yaml"
GPU_ID=0
NUM_WORKERS=4
MAX_EPOCHS=16

# for evaluation
EVAL_ASSESS_CONFIG="config/assess/0_eval_PES_unseen_0.02_4.yaml"
